            ...
            <div className="container mx-auto px-4 py-5 flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-7">
                    ...
                    <div className="relative group">
                        <button className="flex items-center text-gray-600 group-hover:text-blue-600 transition font-medium focus:outline-none">
                            Tentang Kami
                        ...
                        <div className="absolute left-0 mt-2 w-48 bg-white border border-gray-100 rounded-xl shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top top-full">
                            <div className="py-2 flex flex-col">
                                <Link href="" className="px-4 py-2 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition">Sejarah</Link>
                                <Link href="" className="px-4 py-2 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition">Guru & Staf</Link>
                                <Link href="" className="px-4 py-2 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition">Fasilitas</Link>
                            </div>
                        </div>
                    </div>
                    <div className="relative group">
                        ...
                        <div className="absolute left-0 mt-2 w-48 bg-white border border-gray-100 rounded-xl shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top top-full">
                            <div className="py-2 flex flex-col">
                                <Link href="" className="px-4 py-2 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition">Kelas Reguler</Link>
                                <Link href="" className="px-4 py-2 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition">Les Privat</Link>
                    ...
                    <Link href="/profil" className="text-gray-600 hover:text-blue-600 transition">Galeri</Link>
                        ...
                        <div>
                            ...
                            {isProfilMobileOpen && (
                                <div className="mt-2 ml-4 border-l-2 border-gray-200 flex flex-col space-y-3 pl-4">
                                    <Link href="" onClick={() => setIsOpen(false)} className="text-gray-500 hover:text-blue-600">Sejarah</Link>
